...
enum opt_code
{
  ...
  OPT_mbionic = 1137,                        /* -mbionic */
  OPT_mboard_ = 1138,                        /* -mboard= */
  OPT_mcmov = 1139,                          /* -mcmov */
  OPT_mcompat_delay = 1140,                  /* -mcompat-delay */
  OPT_mdelay = 1141,                         /* -mdelay */
  OPT_mdouble_float = 1142,                  /* -mdouble-float */
  OPT_mglibc = 1143,                         /* -mglibc */
  OPT_mhard_div = 1144,                      /* -mhard-div */
  OPT_mhard_float = 1145,                    /* -mhard-float */
  OPT_mhard_mul = 1146,                      /* -mhard-mul */
  OPT_mnewlib = 1147,                        /* -mnewlib */
  OPT_mno_delay = 1148,                      /* -mno-delay */
  OPT_mpadstruct = 1149,                     /* -mpadstruct */
  OPT_mredzone_ = 1150,                      /* -mredzone= */
  OPT_mror = 1151,                           /* -mror */
  OPT_msext = 1152,                          /* -msext */
  OPT_msoft_div = 1153,                      /* -msoft-div */
  OPT_msoft_float = 1154,                    /* -msoft-float */
  OPT_msoft_mul = 1155,                      /* -msoft-mul */
