...
enum opt_code
{
  ...
  OPT_mnewlib = 1148,                        /* -mnewlib */
  OPT_mno_delay = 1149,                      /* -mno-delay */
  OPT_mpadstruct = 1150,                     /* -mpadstruct */
  OPT_mredzone_ = 1151,                      /* -mredzone= */
  OPT_mror = 1152,                           /* -mror */
  OPT_msext = 1153,                          /* -msext */
  OPT_msoft_div = 1154,                      /* -msoft-div */
  OPT_msoft_float = 1155,                    /* -msoft-float */
  OPT_msoft_mul = 1156,                      /* -msoft-mul */
